...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_text(
        _["gban_6"].format(mention, number_of_chats, user.id, disable_web_page_preview=True)
    )
    await mystic.delete()
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_text(
        _["gban_9"].format(mention, number_of_chats, user.id, disable_web_page_preview=True)
    )
    await mystic.delete()
